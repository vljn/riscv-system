...
--synthesis_resources = 
 ...
 ENTITY  const_4_lpm_constant_v09 IS 
	 PORT 
	 ( 
		 result	:	OUT  STD_LOGIC_VECTOR (31 DOWNTO 0)
	 ); 
 END const_4_lpm_constant_v09;

 ARCHITECTURE RTL OF const_4_lpm_constant_v09 IS

 BEGIN

	result <= "00000000000000000000000000000100";

 END RTL; --const_4_lpm_constant_v09
--VALID FILE
...
ARCHITECTURE RTL OF const_4 IS

	SIGNAL sub_wire0	: STD_LOGIC_VECTOR (31 DOWNTO 0);



	COMPONENT const_4_lpm_constant_v09
	PORT (
			result	: OUT STD_LOGIC_VECTOR (31 DOWNTO 0)
	);
	END COMPONENT;
...
BEGIN
	...
	const_4_lpm_constant_v09_component : const_4_lpm_constant_v09
	PORT MAP (
		result => sub_wire0
	);
